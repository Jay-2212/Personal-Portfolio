...
export function BreakEvenBar({
  ...
  const scaleMax = Math.max(usagePerDay, breakEvenUsagePerDay, 1) * 1.1;
  ...
  return (
    <div className="break-even-bar" data-clears={clearsBreakEven}>
      <div className="break-even-bar__track">
        <div
          className="break-even-bar__safe-zone"
        ...
        />
        <div
          className="break-even-bar__usage-marker"
          style={{ left: `${usagePct}%` }}
          tabIndex={0}
      ...
      <div className="break-even-bar__legend">
        <span>
          <i className="break-even-bar__legend-threshold" aria-hidden="true" />
          <strong>{formatNumber(breakEvenUsagePerDay, 1)}</strong> break-even threshold
        </span>
        <span>
          <i className="break-even-bar__legend-usage" aria-hidden="true" />
